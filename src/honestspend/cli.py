...
def _require_plain_engine():
    ...
    from honestspend.services.db_crypto import refuse_offline_open_if_encrypted
...
def cmd_tax_packet(args: argparse.Namespace) -> int:
    ...
    from honestspend.services.tax_packet import write_tax_packet_dir
...
def cmd_tray(args: argparse.Namespace) -> int:
    from honestspend.tray import run_tray
...
def cmd_backup(args: argparse.Namespace) -> int:
    ...
    from honestspend.services.backup import create_backup, maybe_auto_backup, prune_backups
    ...
    try:
        ...
        if not user:
            if not args.create:
                ...
                return 1
            from honestspend.services.permissions import Role
