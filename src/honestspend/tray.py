...
def run_tray(*, poll_seconds: int = 60) -> None:
    ...
    from honestspend.services.paths_util import (
        clear_pid,
        pid_alive,
        read_pid,
        tray_pid_path,
    ...
    def _winui_candidates() -> list:
        ...
        try:
            ...
            pass
        for env_key in ("HONESTSPEND_WINUI", "HonestSpend_WINUI", "FOS_WINUI"):
    ...
    def open_inbox_folder(icon=None, item=None):
        ...
        try:
            from honestspend.services.import_inbox import ensure_inbox_layout
