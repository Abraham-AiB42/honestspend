...
@app.get("/api/health")
def health():
    return {"ok": True, "version": __version__, "app": settings.app_name, "product": "LedgerRing"}
...
def credit_api_status():
    return {
        ...
        "message": (
            ...
            "for third-party apps. LedgerRing scores and debt plans use your in-app debts "
