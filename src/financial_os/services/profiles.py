...
from financial_os.db import Category, Profile
from financial_os.seed import load_coa, make_category_row
...
def apply_coa_for_profile(session: Session, profile: Profile) -> int:
    ...
    session.flush()
    try:
        from financial_os.services.categorizer import seed_rules_for_profile
