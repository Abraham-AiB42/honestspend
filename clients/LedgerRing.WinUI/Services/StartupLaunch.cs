...
/// <summary>
/// HKCU Run key — launch LedgerRing at Windows logon (no admin required).
/// </summary>
public static class StartupLaunch
{
    private const string RunKey = @"Software\Microsoft\Windows\CurrentVersion\Run";
    private const string ValueName = "LedgerRing";
    ...
    public static void Enable(string? exePath = null, string? arguments = null, bool trayOnly = true)
    {
        exePath ??= Environment.ProcessPath
            ?? Path.Combine(AppContext.BaseDirectory, "LedgerRing.WinUI.exe");
