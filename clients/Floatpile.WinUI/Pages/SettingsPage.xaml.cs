...
public sealed partial class SettingsPage : Page
{
    ...
    /// <summary>Query Task Scheduler for Floatpile-AutoBackup / Floatpile-Digest (current user).</summary>
    ...
    private void SuggestOneDrive_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            var target = Path.Combine(od, "Floatpile", "data");
    ...
    private async void StartTray_Click(object sender, RoutedEventArgs e)
    {
        try
        {
            ...
            StatusText.Text = ok
                ? "Tray started — hover for Safe to spend; Open Floatpile opens this desktop app."
