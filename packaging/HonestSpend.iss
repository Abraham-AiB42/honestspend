...
DefaultDirName={autopf}\HonestSpend
DefaultGroupName=HonestSpend
DisableProgramGroupPage=yes
LicenseFile=..\LICENSE
OutputDir=..\dist
OutputBaseFilename=HonestSpend-Setup-x64
Compression=lzma2
...
Name: "logonstart"; Description: "Start HonestSpend tray-only at Windows logon"; GroupDescription: "Startup:"; Flags: unchecked
...
begin
  ...
  begin
    MsgBox('Source folder missing: dist\HonestSpend-Windows-x64\'#13#10 +
